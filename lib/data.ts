      ...
      subjects: [
        {
          id: "history", name: "History", nameHi: "इतिहास", icon: "book",
          books: [
            { id: "history-12-1", name: "Themes in Indian History Part 1", nameHi: "भारतीय इतिहास के कुछ विषय भाग 1", chapters: [] },
            { id: "history-12-2", name: "Themes in Indian History Part 2", nameHi: "भारतीय इतिहास के कुछ विषय भाग 2", chapters: [] },
            { id: "history-12-3", name: "Themes in Indian History Part 3", nameHi: "भारतीय इतिहास के कुछ विषय भाग 3", chapters: [] },
          ],
        },
        {
          id: "geography", name: "Geography", nameHi: "भूगोल", icon: "map",
          books: [
            { id: "geo-12-1", name: "Fundamentals of Human Geography", nameHi: "मानव भूगोल के मूल सिद्धांत", chapters: [] },
            { id: "geo-12-2", name: "India – People and Economy", nameHi: "भारत – लोग और अर्थव्यवस्था", chapters: [] },
          ],
        },
        {
          id: "political-science", name: "Political Science", nameHi: "राजनीति विज्ञान", icon: "landmark",

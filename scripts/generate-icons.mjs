...
const SOURCE = path.resolve("public/icons/source-logo.png");
...
async function generateIcons() {
  ...
  // Generate maskable icon (with safe area padding - 10% padding on each side)
  // Maskable icons need a safe zone: the important content within 80% center circle

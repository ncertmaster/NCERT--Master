...
import { LogOut, Timer, BookMarked, Shield, ChevronRight } from "lucide-react"
...
export function SettingsScreen() {
  ...
  const menuItems = [
    { icon: Timer, label: "Time Management", sublabel: "Pomodoro timer, schedule & daily routine", iconBg: "bg-violet-500/15 text-violet-400", onClick: () => setScreen("study-timer") },
    { icon: BookMarked, label: "My Diary", sublabel: "Notes, goals and life journal", iconBg: "bg-amber-500/15 text-amber-400", onClick: () => setScreen("diary") },
    { icon: Shield, label: "Privacy Policy", sublabel: "Data usage and AI policy", iconBg: "bg-emerald-500/15 text-emerald-400", onClick: () => setScreen("privacy-policy") },
  ]

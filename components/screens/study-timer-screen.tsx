...
export function StudyTimerScreen() {
  ...
  const toggleTask = async (task: Task) => {
    ...
    if (!error) setTasks(prev => prev.map(t => t.id === task.id ? { ...t, completed: newCompleted, streak: newStreak } : t))
  }
            ...
            <div className="rounded-2xl border border-border/60 bg-card p-5 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => setShowTimerSettings(s => !s)} className="p-1.5 rounded-lg hover:bg-secondary text-muted-foreground transition-colors">
